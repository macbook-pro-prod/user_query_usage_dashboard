...
BEGIN TRANSACTION;
--dev-shared-dwh01.ds_dwh01_shared.jobs_by_project
-- 1. Delete the historical period that will be rebuilt
DELETE FROM `dev-shared-dwh01.ds_dwh01_shared.jobs_by_project` -- change to certain project to backfilling
...
INSERT INTO `dev-shared-dwh01.ds_dwh01_shared.jobs_by_project` -- change to certain project to backfilling
(
  start_time,
  user_email,
  job_type,
...
FROM `dev-shared-dwh01.region-asia-southeast1.INFORMATION_SCHEMA.JOBS_BY_PROJECT` -- change to certain project to backfilling
