...
ALTER TABLE `prod-shared-dwh01.ds_dwh01_shared.jobs_by_project_prod_sql_scripting` 
...
DELETE FROM `prod-shared-dwh01.ds_dwh01_shared.jobs_by_project_prod_sql_scripting` -- change to certain project to backfilling
...
INSERT INTO `prod-shared-dwh01.ds_dwh01_shared.jobs_by_project_prod_sql_scripting` -- change to certain project to backfilling
(
  start_time,
  user_email,
  job_type,
...
FROM  `prod-sql-scripting.region-asia-southeast1.INFORMATION_SCHEMA.JOBS_BY_PROJECT` -- change to certain project to backfilling
